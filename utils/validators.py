    ...
    def check_length(self, text, min_length, max_length):
        while True:
            if self.has_valid_length(text, min_length, max_length):
                ...
                text = input(f"(!) - Veuillez entrer un texte de {min_length} à {max_length} caractères: ")
    ...
    def check_min_length(self, text, min_length):
        while True:
            if self.has_min_length(text, min_length):
                ...
                text = input(f"(!) - Veuillez entrer un texte de {min_length} caractères minimum: ")
    ...
    def check_interval(self, text, min_number, max_number):
        while True:
            if self.has_valid_interval(text, min_number, max_number):
                ...
                text = input(f"(!) - Veuillez entrer un nombre entre {min_number} et {max_number}: ")
    ...
    def check_letters(self, text):
        while True:
            if self.has_only_letters(text):
                ...
                text = input("(!) - Veuillez entrer un texte avec uniquement des lettres: ")
    ...
    def check_more_than_8_caracters(self, text):
        while True:
            if self.has_more_than_8_caracters(text):
                ...
                text = input(f"(!) - Veuillez entrer un texte avec plus de 8 caractères: ")
    ...
    def check_letter_and_digit(self, text):
        while True:
            if self.has_letter_and_digit(text):
                ...
                text = input("(!) - Veuillez entrer un texte avec au moins une lettre et un chiffre: ")
    ...
    def check_min_length(self, text, min_length):
        while True:
            if self.has_min_length(text, min_length):
                ...
                text = input(f"(!) - Veuillez entrer un texte avec au moins {min_length} caractères: ")
    ...
    def check_special_character(self, text):
        while True:
            if self.has_special_character(text):
                ...
                text = input("(!) - Veuillez entrer un texte avec au moins un caractère spécial: ")
...
class Validators(Basic_Validators):
    ...
    def validator_simple_text(self, input_name: str, input_display: str, is_update: bool):
